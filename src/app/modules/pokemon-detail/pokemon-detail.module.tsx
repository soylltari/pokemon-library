...
export const PokemonDetail = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center gap-10 md:gap-16 py-10 px-4 md:px-10">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <Card size="sm">
            <CardContent className="pt-3">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Base EXP</p>
            </CardContent>
          </Card>
        </div>
